...
const subscriptionSchema = new Schema<PiMiaTypes.ISubscription,Subscription,PiMiaTypes.ISubscriptionMethods>({
  statusUpdates:Utils.getStatusArraySchema(Object.values(PiMiaTypes.ISubscriptionStatuses),PiMiaTypes.ISubscriptionStatuses.NEW),
...
subscriptionSchema.methods.json = function () {
  const json:Partial<PiMiaTypes.ISubscription> =  {};
  ...
  return json as PiMiaTypes.ISubscription;
};

type Subscription = Model<PiMiaTypes.ISubscription,{},PiMiaTypes.ISubscriptionMethods>;
const Subscription:Subscription = mongoose.model<PiMiaTypes.ISubscription>('subscriptions',subscriptionSchema);
