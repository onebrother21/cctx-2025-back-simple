...
const venueSchema = new Schema<DegenTypes.IDegenVenue,DegenVenue,DegenTypes.IDegenVenue>({
...
type DegenVenue = Model<DegenTypes.IDegenVenue,{},DegenTypes.IDegenVenue>;
