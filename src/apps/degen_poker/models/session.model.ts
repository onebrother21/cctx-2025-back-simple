...
const sessionSchema = new Schema<DegenTypes.IDegenSession,DegenSession,DegenTypes.IDegenSession>({
...
type DegenSession = Model<DegenTypes.IDegenSession,{},DegenTypes.IDegenSession>;
