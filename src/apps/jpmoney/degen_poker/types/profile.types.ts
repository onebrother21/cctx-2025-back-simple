...
export type IDegenPokerPlayer = Types.IProfile & {
  meta:{
    user:string;
    scopes:string[];
    rateAmt:number;
...
export type IDegenPokerAdmin = Types.IProfile & {
  meta:{
    user:string;
    scopes:string[];
    rateAmt:number;
...
export enum IDegenPokerProfileActions {
  // AUTH
  TEST_AUTH = "logged in",
...
export enum IDegenPokerProfileActionsUF {
  // AUTH
  TEST_AUTH = "test-auth",
