...
const lineItemSchema = new Schema<ECSTypes.IFinancialLineItem,FinancialLineItem,ECSTypes.IFinancialLineItemMethods>({
  statusUpdates:Utils.getStatusArraySchema(Object.values(ECSTypes.IFinancialLineItemStatuses),ECSTypes.IFinancialLineItemStatuses.NEW),
...
type FinancialLineItem = Model<ECSTypes.IFinancialLineItem,{},ECSTypes.IFinancialLineItemMethods>;
const FinancialLineItem:FinancialLineItem = mongoose.model<ECSTypes.IFinancialLineItem>('lineItems',lineItemSchema);
