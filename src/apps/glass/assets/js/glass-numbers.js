...
export class GlassNumbers {
  initTabs = () => {
    ...
    tabLinks.forEach((link,i) => {
      ...
      const currentTab = gs.get("nav_currentTab") || 0;
  ...
  setTab = (link,i,tabId) => {
    ...
    gs.set("nav_currentTab",i);
  };
  populateStrategyResults = () => {
    const {data,results} = gs.get("lastStrategyResults") || {};
  ...
  populateStrategySimResults = () => {
    const {data,results} = gs.get("lastStrategySimResults") || {};
  ...
  populateCalcComboResults = () => {
    const {data,results} = gs.get("lastCalcComboResults") || {};
  ...
  populateDerivedAlgorithm = () => {
    const {data,results} = gs.get("lastDerivedAlgo") || {};
  ...
  runSingleStrategy = async (data) => {
    try{
      ...
      gs.set("lastStrategyResults",{data,results});
  ...
  runStrategySim = async (data) => {
    try{
      ...
      const results = body.data;
      gs.set("lastStrategySimResults",{data,results});
  ...
  calcComboProbility = async (data) => {
    try{
      ...
      const results = body.data;
      gs.set("lastCalcComboResults",{data,results});
  ...
  deriveAlgoFromLast5 = async (data) => {
    try{
      ...
      const results = body.data;
      gs.set("lastDerivedAlgo",{data,results});
